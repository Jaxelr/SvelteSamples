...
<div id="list-items" bind:this="{listRef}">
  <div class="head">
    <i>
      Note from original author: I took this list from
  ...
  <div class="tail">
    <i>
      ...
      View original source on <a href="https://gitlab.com/brycedorn/svelte-reactive-map-list">GitLab</a>.
    </i>
  </div>
</div>
